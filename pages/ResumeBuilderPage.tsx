...
function ResumeBuilderPage({
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      try {
        latoRegularBase64 = await getFontBase64("/ResumeBuilder_TPF_V1/fonts/Lato-Regular.ttf");
        latoBoldBase64 = await getFontBase64("/ResumeBuilder_TPF_V1/fonts/Lato-Bold.ttf");
      } catch (error) {
        console.error("Font loading error", error);
      }

      try {
        cambriaBase64 = await getFontBase64("/ResumeBuilder_TPF_V1/fonts/Cambria-Regular.ttf");
      } catch (error) {
