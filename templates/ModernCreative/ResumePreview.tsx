...
const THEME_PALETTES: Record<
  string,
  { textPrimary: string; textSecondary: string; border: string; tagBg: string }
> = {
  "#0f172a": {
    textPrimary: "#E7E8EA",
    textSecondary: "#9FA2A9",
    border: "#3F4554",
    tagBg: "#272E3F",
  }, // Slate
  "#7f1d1d": {
    textPrimary: "#F2E8E8",
    textSecondary: "#CBA4A4",
    border: "#984A4A",
    tagBg: "#8B3333",
  }, // Maroon
  "#1e3a8a": {
  ...
  "#581c87": {
    textPrimary: "#EEE8F3",
    textSecondary: "#BCA4CF",
    border: "#79499F",
    tagBg: "#683293",
  }, // Purple
  "#134e4a": {
    textPrimary: "#E7EDEC",
    textSecondary: "#A0B8B6",
    border: "#42716E",
    tagBg: "#2A5F5C",
  }, // Teal
  "#000000": {
  ...
  ({ resumeData, themeColor }, ref) => {
    ...
    return (
      ...
      >
        {/* Sidebar - Left Column */}
        <div
          className="w-[35%] px-6 pb-6 flex flex-col min-h-full flex-shrink-0 print:bg-red-500 modern-creative-sidebar"
          style={sidebarStyle}
        >
          {/* Photo */}
              ...
              <div className="space-y-4">
                {education.map((edu, idx) => (
                  <div key={idx}>
                    ...
                    <p className="text-xs mb-1" style={primaryTextStyle}>
                      {edu.institution}
                    </p>
                    <div
        ...
        <div className="w-[65%] px-6 pb-6 flex flex-col bg-white modern-creative-right-column pt-10">
          ...
          <div className="mb-6">
            <h1
              className="text-4xl font-black tracking-tight uppercase mb-2"
                      ...
                      act.description.trim() !== "" && (
                        <div key={idx}>
                          ...
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: renderHTML(act.description),
                            }}
                          ></div>
                        </div>
                      )
