...
const ResumePreview = forwardRef<HTMLDivElement, ResumePreviewProps>(({ resumeData }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white shadow-lg pt-6 px-10 pb-2 leading-relaxed w-[210mm] text-black" style={{ fontFamily: 'Lato, sans-serif' }}>
      <header className="flex items-start justify-between pb-4 text-[15px]">
        <div className="flex items-center flex-grow min-w-0">
            ...
            <div className="flex-grow min-w-0">
                <h1 className="font-bold tracking-wide break-words text-[25px] leading-none">{personalDetails.name}</h1>
